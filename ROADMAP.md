...
| ----: | :------: | ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|     1 |    P1    | Complete Calendar 2.0 — implemented for review    | The twelve-month private reading rhythm and exact-month planning sheet now share one responsive workspace. The design keeps a 365-cell streak heatmap deferred, preserves the shared history and flexible-date model, and repairs the seeded visual audit. See [task-calendar-cluster-scope.md](docs/tasks/task-calendar-cluster-scope.md). |
...
3. **Calendar/Releases cluster — Calendar 2.0 implemented for review.** The sparse calendar and
   release-horizon passes shipped. The annual-rhythm follow-up resolves the remaining route,
   density, phone-width, year, and heatmap decisions in
   `docs/tasks/task-calendar-cluster-scope.md` without adding another data model.
