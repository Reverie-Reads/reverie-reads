...
Hardcover enrichment does not inspect a successful-HTTP GraphQL `errors` array. Fast enrichment
...
acceptance and dropped CSV page count. It contains no personal library data or provider payload.
