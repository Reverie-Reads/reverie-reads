...
import { mergeCorpusShadowExaReports } from './authority/corpus-shadow-exa-merge.mjs'
...
const usage = 'Usage: authority:corpus-shadow:exa:merge --input BATCH.json [...] --out MERGED.json'
...
const merged = mergeCorpusShadowExaReports(reports)
...
console.log(
  JSON.stringify({
    ...
    reviewSha256: merged.reviewSha256,
