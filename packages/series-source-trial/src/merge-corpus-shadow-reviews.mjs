...
import { mergeCorpusShadowReviewReports } from './authority/corpus-shadow-review-merge.mjs'
...
const usage =
  'Usage: authority:corpus-shadow:review:merge --input REVIEW.json [...] --out MERGED.json'
...
const merged = mergeCorpusShadowReviewReports(reports)
...
console.log(
  JSON.stringify({
    ...
    inputSha256: merged.inputSha256,
    batches: merged.inputBatches.length,
    counts: merged.counts,
    exaQueue: {
      groups: merged.exaQueue.groups,
      works: merged.exaQueue.works,
      unresolved: merged.exaQueue.unresolved,
      policyQuarantined: merged.exaQueue.policyQuarantined,
    },
    output: outputPath,
  }),
)
