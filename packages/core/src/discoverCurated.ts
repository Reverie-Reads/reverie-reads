// Curated Discover candidates (docs/tasks/task-discover-curated-candidates.md; audit:
// docs/audits/discover-recency.md). The audit proved candidate ACQUISITION is Discover's recency
// problem: recent trade frontlist carries the bare Google category ['Fiction'], so it can never
// match subject: queries — Romance/Fantasy/SF/Mystery measured 0% 2020+ at fn depth. This module
// injects resolved, hand-curated candidates into the pool for exactly those four categories,
